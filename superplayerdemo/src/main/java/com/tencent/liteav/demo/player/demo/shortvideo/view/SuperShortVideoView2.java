...
public class SuperShortVideoView2 extends RelativeLayout {
    ...
    public SuperShortVideoView2(Context context) {
        super(context);
        init(context);
    }

    public SuperShortVideoView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }


    public SuperShortVideoView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public void init(Context context) {
        mRootView = LayoutInflater.from(context).inflate(R.layout.super_short_video_view2, null);
        addView(mRootView);
